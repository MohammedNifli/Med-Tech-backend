...
const mergeNestedArray = (existingArray, updateArray) => {
    return updateArray ? updateArray : existingArray;
};
const mergeDoctorData = (existingData, updateData) => {
    return {
        // Merge personalInfo
        personalInfo: {
        ...
        professionalInfo: {
            ...
            qualifications: mergeNestedArray(existingData.professionalInfo.qualifications, updateData.professionalInfo?.qualifications),
            languages: mergeNestedArray(existingData.professionalInfo.languages, updateData.professionalInfo?.languages),
        },
        // Merge practiceInfo
        practiceInfo: {
            ...existingData.practiceInfo,
            ...updateData.practiceInfo,
            clinics: mergeNestedArray(existingData.practiceInfo.clinics, updateData.practiceInfo?.clinics),
        },
        // Merge financialInfo
        financialInfo: {
