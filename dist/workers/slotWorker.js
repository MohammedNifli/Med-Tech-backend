...
function generateTimeSlots(startDate, endDate, timeSlots, doctorId, availableDays, consultationMode) {
    const slots = [];
...
const generatedSlots = generateTimeSlots(new Date(workerData.startDate), new Date(workerData.endDate), workerData.timeSlots, workerData.doctorId, workerData.availableDays, workerData.consultationMode);
